...
class BoundaryDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.boundary_type = "area"  # Default type
        self.boundary_color = QColor(200, 200, 255, 50)  # Light blue with transparency
    ...
    def setup_ui(self):
        ...
        self.type_combo.addItem("Network Segment", "network")
        self.type_combo.addItem("Security Zone", "security_zone")
        self.type_combo.addItem("Site", "site")
